...
//
// The BOOKING_ASSIGNMENT_ENABLED check lives in the server component that renders
// this (./page.tsx), so with the flag off the route 404s before any of this ships
// or runs. A client component cannot read a server-only flag, which is exactly why
// the gate belongs one level up.
