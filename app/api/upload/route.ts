...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // iPhone HEIC/HEIF → JPEG so the vision model can actually decode it (an
    // un-converted HEIC reaches the model as an unreadable format → it identifies
    // nothing and can't quote). Non-HEIC passes through unchanged.
