...
test('mobile More sheet leads with ONE Team section holding Crew and Team & Access', () => {
  ...
  assert.deepEqual(groups[0].items.map(i => i.href), ['/admin/operations/employees', '/admin/operations/users', '/admin/operations/permissions', '/admin/operations/audit', '/admin/operations/crew-activity', '/admin/operations/punch-overlaps'])
