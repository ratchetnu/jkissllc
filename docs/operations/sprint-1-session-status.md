...
| **Blockers** | **B-1** (merge of #52) · **B-4** ~~Supercharged has never completed a full Operion Preview E2E~~ **withdrawn — UPD-1007 completed it** (run `29697932299` = `success`, Supercharged PR #3); Preview-only flag enablement is Sprint 2 and still needs its own approval · **B-5** SC local `main` is 2 behind `origin/main` |
