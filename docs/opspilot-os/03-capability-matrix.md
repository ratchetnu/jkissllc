...
- _(Updated 2026-07-24, Wave D/E)_ **Full: 25** · **Partial: 11** · **Backend-only: 1** ·
  **Duplicated: 1** · **Absent: 8** · (Permissions matrix now has a read-only viewer; unused-permission enforcement drift still tracked below).
